    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
      <div className="w-full max-w-md space-y-8 bg-white p-8 sm:p-10 rounded-2xl border border-slate-100 shadow-sm">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm">
              <a href="#" className="font-medium text-slate-900 hover:text-slate-600 transition-colors">
                Forgot password?
              </a>
            </div>
          </div>
        ...
        <p className="mt-4 text-center text-sm text-slate-600">
          ...
          <Link href="/signup" className="font-bold text-slate-900 hover:text-slate-600 transition-colors">
            Sign up
          </Link>
        </p>
      </div>
